...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.distributed.recv_like.rst"
...
- <a
  href="https://ml-explore.github.io/mlx/build/html/#mlx.core.distributed.recv_like"
  class="reference internal nav-link"><span class="pre"><code
  class="docutils literal notranslate">recv_like()</code></span></a>
...
<div id="mlx-core-distributed-recv-like" class="section">

# mlx.core.distributed.recv_like<a
href="https://ml-explore.github.io/mlx/build/html/#mlx-core-distributed-recv-like"
class="headerlink" title="Link to this heading">#</a>

<span class="sig-name descname"><span class="pre">recv_like</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">x</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.array.html#mlx.core.array"
class="reference internal" title="mlx.core.array"><span
class="pre">array</span></a></span>*, *<span class="n"><span class="pre">src</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a href="https://docs.python.org/3/library/functions.html#int"
...
Recv an array with shape and type like <span class="pre">`x`</span> from
process with rank <span class="pre">`src`</span>.

It is equivalent to calling
<span class="pre">`mx.distributed.recv(x.shape,`</span>` `<span class="pre">`x.dtype,`</span>` `<span class="pre">`src)`</span>.

Parameters<span class="colon">:</span>  
- **x** (<a
  href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.array.html#mlx.core.array"
  class="reference internal" title="mlx.core.array"><em>array</em></a>)
  – An array defining the shape and dtype of the array we are receiving.
