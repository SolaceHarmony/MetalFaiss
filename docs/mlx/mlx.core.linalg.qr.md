...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.linalg.qr.rst"
...
- <a
  href="https://ml-explore.github.io/mlx/build/html/#mlx.core.linalg.qr"
  class="reference internal nav-link"><span class="pre"><code
  class="docutils literal notranslate">qr()</code></span></a>
...
<div id="mlx-core-linalg-qr" class="section">

# mlx.core.linalg.qr<a
href="https://ml-explore.github.io/mlx/build/html/#mlx-core-linalg-qr"
class="headerlink" title="Link to this heading">#</a>

<span class="sig-name descname"><span class="pre">qr</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">a</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a
...
which are factorized are assumed to be in the last two dimensions of the
input.
...
<span class="pre">`Q`</span> and <span class="pre">`R`</span> matrices
such that
<span class="pre">`Q`</span>` `<span class="pre">`@`</span>` `<span class="pre">`R`</span>` `<span class="pre">`=`</span>` `<span class="pre">`a`</span>.
