...
<!--
Per-file analysis (mlx.core.all.md):
- Boolean all-reduction with axis/keepdims.
- Add note on dtype expectations and empty axes behavior.
-->

## Curated Notes

- Operates on boolean arrays; non‑boolean inputs are coerced by truthiness rules. Cast explicitly with `a.astype(mx.bool_)` to be precise.
- With `axis=None`, reduces over all elements; use `keepdims=True` to preserve rank when composing operations.
...
a = mx.array([[True, True, False], [True, True, True]])
print(mx.all(a))               # False
print(mx.all(a, axis=1))       # [False, True]
print(mx.all(a, axis=1, keepdims=True))  # [[False],[True]] for broadcasting

# Coerce explicitly from numeric
x = mx.array([0, 1, 2])
print(mx.all(x.astype(mx.bool_)))
```
...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.all.rst"
...
- <a href="https://ml-explore.github.io/mlx/build/html/#mlx.core.all"
...
<div id="mlx-core-all" class="section">

# mlx.core.all<a href="https://ml-explore.github.io/mlx/build/html/#mlx-core-all"
class="headerlink" title="Link to this heading">#</a>

<span class="sig-name descname"><span class="pre">all</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">a</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a
...
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.array.html#mlx.core.array"
class="reference internal" title="mlx.core.array"><span
class="pre">array</span></a></span></span><a href="https://ml-explore.github.io/mlx/build/html/#mlx.core.all"
...
<a
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.addmm.html"
...
<a
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.allclose.html"
