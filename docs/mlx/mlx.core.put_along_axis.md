...
<!--
Per-file analysis (mlx.core.put_along_axis.md):
- Scatter/update along an axis; useful for constructing series for plotting or graph structures.
- Hotspot: index/value shape alignment and device control.
-->

## Curated Notes

- `indices` and `values` must broadcast with the target along `axis`.
...
out = mx.put_along_axis(target, idx, vals, axis=1)

# CPU route
out_cpu = mx.put_along_axis(target, idx, vals, axis=1, stream=mx.cpu)
```
...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.put_along_axis.rst"
...
- <a
  href="https://ml-explore.github.io/mlx/build/html/#mlx.core.put_along_axis"
...
<div id="mlx-core-put-along-axis" class="section">

# mlx.core.put_along_axis<a
href="https://ml-explore.github.io/mlx/build/html/#mlx-core-put-along-axis"
class="headerlink" title="Link to this heading">#</a>

<span class="sig-name descname"><span class="pre">put_along_axis</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">a</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.array.html#mlx.core.array"
class="reference internal" title="mlx.core.array"><span
class="pre">array</span></a></span>*, *<span class="o"><span class="pre">/</span></span>*, *<span class="n"><span class="pre">indices</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.array.html#mlx.core.array"
class="reference internal" title="mlx.core.array"><span
class="pre">array</span></a></span>*, *<span class="n"><span class="pre">values</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.array.html#mlx.core.array"
class="reference internal" title="mlx.core.array"><span
...
- **indices** (<a
  href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.array.html#mlx.core.array"
  class="reference internal" title="mlx.core.array"><em>array</em></a>)
  – Indices array. These should be broadcastable with the input array
  excluding the axis dimension.

- **values** (<a
  href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.array.html#mlx.core.array"
  class="reference internal" title="mlx.core.array"><em>array</em></a>)
  – Values array. These should be broadcastable with the indices.

- **axis**
  (<a href="https://docs.python.org/3/library/functions.html#int"
  class="reference external" title="(in Python v3.13)"><em>int</em></a>
  *or* *None*) – Axis in the destination to put the values to. If
  <span class="pre">`axis`</span>` `<span class="pre">`==`</span>` `<span class="pre">`None`</span>
  the destination is flattened prior to the put operation.
...
<a
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.prod.html"
...
<a
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.quantize.html"
