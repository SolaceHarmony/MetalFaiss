...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.divmod.rst"
...
- <a href="https://ml-explore.github.io/mlx/build/html/#mlx.core.divmod"
...
<div id="mlx-core-divmod" class="section">

# mlx.core.divmod<a href="https://ml-explore.github.io/mlx/build/html/#mlx-core-divmod"
class="headerlink" title="Link to this heading">#</a>

<span class="sig-name descname"><span class="pre">divmod</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">a</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">scalar</span><span class="w"> </span><span class="p"><span class="pre">\|</span></span><span class="w"> </span><a
...
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.array.html#mlx.core.array"
class="reference internal" title="mlx.core.array"><span
class="pre">array</span></a></span></span><a href="https://ml-explore.github.io/mlx/build/html/#mlx.core.divmod"
class="headerlink" title="Link to this definition">#</a>  
Element-wise quotient and remainder.

The fuction
<span class="pre">`divmod(a,`</span>` `<span class="pre">`b)`</span> is
equivalent to but faster than
<span class="pre">`(a`</span>` `<span class="pre">`//`</span>` `<span class="pre">`b,`</span>` `<span class="pre">`a`</span>` `<span class="pre">`%`</span>` `<span class="pre">`b)`</span>.
The function uses numpy-style broadcasting semantics. Either or both
