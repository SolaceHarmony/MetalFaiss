...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.grad.rst"
...
- <a href="https://ml-explore.github.io/mlx/build/html/#mlx.core.grad"
  class="reference internal nav-link"><span class="pre"><code
  class="docutils literal notranslate">grad()</code></span></a>
...
<span class="pre">`fun`</span> and returns the gradient(s).
