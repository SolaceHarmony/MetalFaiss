...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.fft.rfft2.rst"
...
- <a
  href="https://ml-explore.github.io/mlx/build/html/#mlx.core.fft.rfft2"
  class="reference internal nav-link"><span class="pre"><code
  class="docutils literal notranslate">rfft2()</code></span></a>
...
<div id="mlx-core-fft-rfft2" class="section">

# mlx.core.fft.rfft2<a
href="https://ml-explore.github.io/mlx/build/html/#mlx-core-fft-rfft2"
class="headerlink" title="Link to this heading">#</a>

<span class="sig-name descname"><span class="pre">rfft2</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">a</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a
...
The output has the same shape as the input except along the dimensions
in <span class="pre">`axes`</span> in which case it has sizes from
<span class="pre">`s`</span>. The last axis in
...
The real DFT of the input along the given axes. The output data type
will be complex.
...
<a
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.fft.irfft2.html"
