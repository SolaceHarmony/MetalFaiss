...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.linalg.cross.rst"
...
- <a
  href="https://ml-explore.github.io/mlx/build/html/#mlx.core.linalg.cross"
  class="reference internal nav-link"><span class="pre"><code
  class="docutils literal notranslate">cross()</code></span></a>
...
<div id="mlx-core-linalg-cross" class="section">

# mlx.core.linalg.cross<a
href="https://ml-explore.github.io/mlx/build/html/#mlx-core-linalg-cross"
class="headerlink" title="Link to this heading">#</a>

<span class="sig-name descname"><span class="pre">cross</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">a</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a
...
specified axis. If the size is 2 then the third value is assumed to be
zero.
...
- **axis**
  ...
  *optional*) – Axis along which to compute the cross product. Default:
...
The cross product of <span class="pre">`a`</span> and
<span class="pre">`b`</span> along the specified axis.
