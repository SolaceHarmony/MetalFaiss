...
<!--
Per-file analysis (mlx.core.any.md):
- Boolean any-reduction with axis/keepdims; complements `all`.
- Add notes on coercion semantics and common debugging pattern.
-->

## Curated Notes

- Works on boolean inputs; non‑boolean arrays are coerced by truthiness (nonzero -> True). Cast explicitly for clarity: `a.astype(mx.bool_)`.
- Use `keepdims=True` to preserve reduced axes for subsequent broadcasting against the original array.
...
a = mx.array([[False, False, False], [False, True, False]])
print(mx.any(a))               # True
print(mx.any(a, axis=0))       # [False, True, False]
print(mx.any(a, axis=0, keepdims=True))  # [[False, True, False]]

# From numeric inputs
x = mx.array([0, 0, 3])
print(mx.any(x.astype(mx.bool_)))  # True
```
...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.any.rst"
...
- <a href="https://ml-explore.github.io/mlx/build/html/#mlx.core.any"
...
<div id="mlx-core-any" class="section">

# mlx.core.any<a href="https://ml-explore.github.io/mlx/build/html/#mlx-core-any"
class="headerlink" title="Link to this heading">#</a>

<span class="sig-name descname"><span class="pre">any</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">a</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a
...
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.array.html#mlx.core.array"
class="reference internal" title="mlx.core.array"><span
class="pre">array</span></a></span></span><a href="https://ml-explore.github.io/mlx/build/html/#mlx.core.any"
...
<a
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.arange.html"
