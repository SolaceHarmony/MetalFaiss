...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.distributed.recv.rst"
...
- <a
  href="https://ml-explore.github.io/mlx/build/html/#mlx.core.distributed.recv"
  class="reference internal nav-link"><span class="pre"><code
  class="docutils literal notranslate">recv()</code></span></a>
...
<div id="mlx-core-distributed-recv" class="section">

# mlx.core.distributed.recv<a
href="https://ml-explore.github.io/mlx/build/html/#mlx-core-distributed-recv"
class="headerlink" title="Link to this heading">#</a>

<span class="sig-name descname"><span class="pre">recv</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">shape</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Sequence</span><span class="p"><span class="pre">\[</span></span><a href="https://docs.python.org/3/library/functions.html#int"
class="reference external" title="(in Python v3.13)"><span
class="pre">int</span></a><span class="p"><span class="pre">\]</span></span></span>*, *<span class="n"><span class="pre">dtype</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a
...
class="pre">Dtype</span></a></span>*, *<span class="n"><span class="pre">src</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a href="https://docs.python.org/3/library/functions.html#int"
class="reference external" title="(in Python v3.13)"><span
...
Recv an array with shape <span class="pre">`shape`</span> and dtype
<span class="pre">`dtype`</span> from process with rank
<span class="pre">`src`</span>.

Parameters<span class="colon">:</span>  
- **shape**
  (*Tuple\[*<a href="https://docs.python.org/3/library/functions.html#int"
  class="reference external" title="(in Python v3.13)"><em>int</em></a>*\]*)
  – The shape of the array we are receiving.

- **dtype** (<a
  href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.Dtype.html#mlx.core.Dtype"
  class="reference internal" title="mlx.core.Dtype"><em>Dtype</em></a>)
  – The data type of the array we are receiving.

- **src**
  (<a href="https://docs.python.org/3/library/functions.html#int"
  class="reference external" title="(in Python v3.13)"><em>int</em></a>)
  – Rank of the source process in the group.

- **group** (<a
  href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.distributed.Group.html#mlx.core.distributed.Group"
  class="reference internal"
  title="mlx.core.distributed.Group"><em>Group</em></a>) – The group of
  processes that will participate in the recv. If set to
...
The array that was received from <span class="pre">`src`</span>.
...
<a
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.distributed.send.html"
