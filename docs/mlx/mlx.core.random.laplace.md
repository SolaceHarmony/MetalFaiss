...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.random.laplace.rst"
...
- <a
  href="https://ml-explore.github.io/mlx/build/html/#mlx.core.random.laplace"
  class="reference internal nav-link"><span class="pre"><code
  class="docutils literal notranslate">laplace()</code></span></a>
...
<div id="mlx-core-random-laplace" class="section">

# mlx.core.random.laplace<a
href="https://ml-explore.github.io/mlx/build/html/#mlx-core-random-laplace"
class="headerlink" title="Link to this heading">#</a>

<span class="sig-name descname"><span class="pre">laplace</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">shape</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Sequence</span><span class="p"><span class="pre">\[</span></span><a href="https://docs.python.org/3/library/functions.html#int"
...
- Parameters: `loc` (location/mean), `scale` (>0). Shape can be provided; parameters broadcast as usual.
- For reproducibility, pass `key=` or split subkeys.
...
l = mx.random.laplace(loc=0.0, scale=1.0, shape=(2, 3))
k = mx.random.key(9)
l1 = mx.random.laplace(0.0, 2.0, (4,), key=k)
l2 = mx.random.laplace(0.0, 2.0, (4,), key=k)  # identical
```
...
- **scale**
  (<a href="https://docs.python.org/3/library/functions.html#float"
  class="reference external" title="(in Python v3.13)"><em>float</em></a>*,*
  *optional*) – The scale “b” of the Laplace distribution.
