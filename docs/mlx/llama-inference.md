...
<!--
Per-file analysis (llama-inference.md):
- Worked example for transformer inference with RoPE and KV cache.
- Add notes on precision, cache shapes, and tokenizer/weights alignment.
-->
