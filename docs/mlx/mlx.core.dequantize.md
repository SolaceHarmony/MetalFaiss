...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.dequantize.rst"
...
- <a
  href="https://ml-explore.github.io/mlx/build/html/#mlx.core.dequantize"
...
<div id="mlx-core-dequantize" class="section">

# mlx.core.dequantize<a
href="https://ml-explore.github.io/mlx/build/html/#mlx-core-dequantize"
class="headerlink" title="Link to this heading">#</a>

<span class="sig-name descname"><span class="pre">dequantize</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">w</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a
...
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.array.html#mlx.core.array"
class="reference internal" title="mlx.core.array"><span
class="pre">array</span></a></span>*, *<span class="n"><span class="pre">group_size</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a href="https://docs.python.org/3/library/functions.html#int"
...
Dequantize the matrix <span class="pre">`w`</span> using the provided
<span class="pre">`scales`</span> and <span class="pre">`biases`</span>
and the <span class="pre">`group_size`</span> and
<span class="pre">`bits`</span> configuration.

Formally, given the notation in <a
...
we compute <span class="math notranslate nohighlight">\\w_i\\</span>
from <span class="math notranslate nohighlight">\\\hat{w_i}\\</span> and
corresponding <span class="math notranslate nohighlight">\\s\\</span>
and <span class="math notranslate nohighlight">\\\beta\\</span> as
follows
...
The dequantized version of <span class="pre">`w`</span>
