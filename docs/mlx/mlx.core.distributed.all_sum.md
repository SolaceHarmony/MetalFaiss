...
- <a
  href="https://ml-explore.github.io/mlx/build/html/_sources/python/_autosummary/mlx.core.distributed.all_sum.rst"
...
- <a
  href="https://ml-explore.github.io/mlx/build/html/#mlx.core.distributed.all_sum"
  class="reference internal nav-link"><span class="pre"><code
  class="docutils literal notranslate">all_sum()</code></span></a>
...
<div id="mlx-core-distributed-all-sum" class="section">

# mlx.core.distributed.all_sum<a
href="https://ml-explore.github.io/mlx/build/html/#mlx-core-distributed-all-sum"
class="headerlink" title="Link to this heading">#</a>

<span class="sig-name descname"><span class="pre">all_sum</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">x</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a
...
Sum the <span class="pre">`x`</span> arrays from all processes in the
group.
...
- **group** (<a
  ...
  processes that will participate in the reduction. If set to
...
The sum of all <span class="pre">`x`</span> arrays.
...
<a
href="https://ml-explore.github.io/mlx/build/html/python/_autosummary/mlx.core.distributed.init.html"
